...
class WebPagination extends StatefulWidget {
  ...
  const WebPagination({Key? key, required this.onPageChanged, required this.currentPage, required this.totalPage, this.displayItemCount = 11}) : super(key: key);
...
class _WebPaginationState extends State<WebPagination> {
  ...
  //       decoration: BoxDecoration(borderRadius: BorderRadius.circular(2), border: Border.all(color: const Color(0xFFE3E3E3), width: 1)),
  //       width: 50,
  //       child: TextField(
  ...
  //         style: const TextStyle(textBaseline: TextBaseline.alphabetic, color: Color(0xFF0175C2), fontSize: 15, height: 1.5, fontWeight: FontWeight.w600),
...
class _PageControlButton extends StatefulWidget {
  ...
  const _PageControlButton({Key? key, required this.enable, required this.title, required this.onTap}) : super(key: key);
...
class _PageItem extends StatefulWidget {
  ...
  const _PageItem({Key? key, required this.page, required this.isChecked, required this.onTap}) : super(key: key);
    ...
    return InkWell(
        ...
        child: _ItemContainer(
          child: Text(
            ...
            style: TextStyle(color: widget.isChecked ? Colors.white : highlightColor, fontWeight: FontWeight.w600, fontSize: 14),
          ),
...
class _ItemContainer extends StatelessWidget {
  ...
  const _ItemContainer({Key? key, required this.child, required this.backgroundColor}) : super(key: key);
