...
class DiffTopographyWidget extends StatefulWidget {
  final List<DiffTopographyModel> list;
  const DiffTopographyWidget({Key? key, required this.list}) : super(key: key);

  @override
  State<DiffTopographyWidget> createState() => _DiffTopographyWidgetState();
}

class _DiffTopographyWidgetState extends State<DiffTopographyWidget> {
